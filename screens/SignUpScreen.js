...
import { Input, Button, Logo, Heading, BackgroundWrapper, AlertStatus } from "../components/uiComponents";
...
export default class SignUpScreen extends Component {
  ...
  handleRegister() {
    Alert.alert("Button press", "Created user");
  }
  ...
  render() {
    return (
      ...
      >
        ...
        <AlertStatus
      textHelper="You're ready account"
      textAction="Login"
